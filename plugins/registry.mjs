...
export const contributions = [
  ...
  { id: 'inbox',              label: 'Inbox',              entry: '/contrib/inbox.js',              description: 'What needs the owner: candidates and validated artifacts awaiting a verdict. Point it at a folder with wiring config { watch: \'outputs\' }; the default watches nothing.' },
